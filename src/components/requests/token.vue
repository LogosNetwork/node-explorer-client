<template>
  <b-card-text>
    <img v-if="tokenInfo.issuerInfo.image" class="avatar mr-2" :src="tokenInfo.issuerInfo.image">
    ...
    <b-link :title="tokenInfo.name" :href="'/'+tokenInfo.tokenAccount">{{tokenInfo.name}} - {{tokenInfo.symbol}}</b-link>
  </b-card-text>
</template>
