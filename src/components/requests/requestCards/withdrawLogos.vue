  ...
  <b-card no-body class="text-left">
    ...
    <b-list-group flush>
      <b-list-group-item>
        ...
        <span v-if="requestInfo.transaction.amountInLogos" class="text-success mr-2">{{requestInfo.transaction.amountInLogos}}</span>
        <span v-if="typeof requestInfo.transaction.amountInLogos === 'undefined'" class="text-success mr-2">{{requestInfo.transaction.amount}}</span>
        <span>Logos</span>
      </b-list-group-item>
    </b-list-group>
  </b-card>
